// nvcc -lineinfo -res-usage -arch=sm_75 -std=c++14 22111090-prob3-v2.cu -o 22111090-prob3-v2
...
void gridloopsearch(double *a, double *b, double kk) {
    ...
    gridloopsearch_kernel<<<gridSize, blockSize, sz * 3 * sizeof(double)>>>(d_pnts, d_results, d_a, d_b, d_kk);
